...
<form class="layui-form" lay-filter="cms-user-edit-table" id="cms-user-edit-table" style="padding: 20px 0 0 0;">
...
<%--   隐藏表单域  --%>
    ...
    <div class="layui-form-item" pane="">
        ...
        <div class="layui-input-block">
            ...
            <input type="checkbox" name="roles" lay-skin="primary" title="普通用户" value="2">
    ...
    <div class="layui-form-item layui-hide">
        <input type="button" lay-submit lay-filter="cms-user-edit" id="cms-user-edit" value="确认">
    </div>
</form>
